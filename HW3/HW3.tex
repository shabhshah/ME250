...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|p{3.5in}|}
		...
		\hline
		Front axle & Ball bearing & Allow the front axle to turn freely and move the wheel \\
		\hline
		Rear axle & Ball bearing & Allow the rear axle to turn freely and move the wheel \\
		\hline
		Brake handle & Ball bearing & Allow the brake handle to be pulled smoothly during braking \\
		\hline
		Front sprocket & Ball bearing & Allow the front sprocket to turn freely while pedaling \\
		\hline
		Rear sprocket & Ball bearing & Allow the rear gear assembly to turn freely while pedaling \\
		\hline
		Derailleur tensioner & Ball bearing & Allow the derailleur to move freely when tensioning the chain \\
		\hline
		Derailleur gear change & Ball bearing & Allow the derailleur to be at an angle from its mounting point so gears can be changed \\
		\hline
		Derailleur sprocket & Ball bearing & Allow the sprockets to turn freely while pedaling \\
		\hline
		Handlebars & Ball bearing & Allow the fork tube to turn freely while steering \\
		\hline
		Fork tube & Ball bearing & Allow the fork (attached to fork tube) to turn freely while steering \\
		\hline
	\end{tabular}
